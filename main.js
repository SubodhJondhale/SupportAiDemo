...
let agentId = "agt_A99VNFvu"

// 3. Paste the 'data-client-key' in the 'auth.clientKey' variable
let auth = { type: 'key', clientKey: "Z29vZ2xlLW9hdXRoMnwxMDg1NjA0NzA2MTY5MTAxOTQ0MTM6M1o4ZTVmSHlERThVaS1WNHc5VDYy" };
...
function handleSuccess(stream) {
    ...
    // Optional: Visualize the audio input

    // Example usage: Set the stream to an audio element
...
// Call this function when ready to request microphone access

...
let agentId = "agt_8DkISAWq"

// 3. Paste the 'data-client-key' in the 'auth.clientKey' variable
let auth = { type: 'key', clientKey: "YXV0aDB8Njc1MDEzMzZjMzVjMGQyYTA1NGRkZTQ4OjUtNGJfWDhNNlVPWHJFRjVadHlRVw==" };
...
const callbacks = {
    ...
    onNewMessage(messages, type) {
        ...
        let newId = "msg.id"
        if(type != "answer" && msg.role == "assistant"){
            return
        }
        ...
        function addMessage(message) {
            answers.innerHTML += `${msg.role} : ${msg.content}  <br>  <br>`
        ...
        //     if (type == "answer") {
        //         answers.innerHTML += `${timeDisplay()} - [${msg.role}] : ${msg.content} `
